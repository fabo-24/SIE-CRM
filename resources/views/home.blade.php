        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="duplicateAlert" class="alert alert-warning d-none" role="alert">
                    Estás editando una copia de este evento. Modifica los datos si es necesario y luego guarda.
                </div>
                <form id="eventForm">
                    ...
                    <button type="button" class="btn btn-secondary" id="duplicateEventBtn">Duplicar</button>
                </form>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    slotMaxTime: "21:00:00",
        ...
        select: function(info) {
            ...
            document.getElementById('event_etiqueta').value = 'SOPORTE';
        ...
        eventClick: function(info) {
            ...
            let startStr = formatDateLocal(new Date(info.event.start));
            let endStr = formatDateLocal(new Date(info.event.end));
    ...
    document.getElementById('duplicateEventBtn').addEventListener('click', function () {
        document.getElementById('duplicateAlert').classList.remove('d-none');
        document.getElementById('event_id').value = '';

        let originalTitle = document.getElementById('event_title').value;
        if (!originalTitle.includes('(Copia)')) {
            document.getElementById('event_title').value = originalTitle + ' (Copia)';
        }
    ...
    function getColorByEtiqueta(etiqueta) {
        ...
        return colors[etiqueta] || etiqueta;
    }
});
</script>
<style>
